...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
    return (
        <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat bg-center lg:rounded-r-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
    return (
        <section className='2xl:max-container relative flex flex-col lg:mb-10 lg:py-20 xl:mb-20 py-10'>
            <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
                <CampSite
                    backgroundImage='bg-bg-img-1'
                    title='Wild Horizons Camping'
                ...
                <CampSite
                    ...
                    subtitle='Camping Jungfrau, Campground Arolla'
                    peopleJoined='50+ Joined'
                />
            </div>
            <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
                <div className='bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'>
                    ...
                    <Image src={quote} alt={'quote'} height={219} width={186} className='camp-quote'/>
                </div>
            </div>
        </section>
    )
